        ...
        <div class="row">
            <div class="col-xs-12 col-sm-4">
                <a href="{{ route('Home.index') }}"><img
                        src="{{ asset('public-images/Chance-logo.png') }}"style="width: 8em;height: 4em;"
                        alt="chance logo"></a>
                <div class="space-20"></div>
                <p>Chacne Digital Library An advanced library that was made to make it easier for students to access
